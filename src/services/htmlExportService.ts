          ...
          <div class="day">
            ...
            ${day.activities.map(activity => `
              <div class="activity">
                ...
                ${activity.location ? `<div class="location">📍 <a href="https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(activity.location)}" target="_blank" style="color: #007bff; text-decoration: underline;">${activity.location}</a></div>` : ''}
              </div>
            `).join('')}
          </div>
        `).join('')}
